...
- pyttsx3를 활용한 TTS 기능으로 음성 콘텐츠 제공
...
- Redis에 대한 설정 완료: `RedisConfig` 클래스로 구성
...
2. 외부 API 연동: KoBART API, Pexels API, pyttsx3 API
...
- **도전 과제**
    ...
    - 외부 AI API 연동 시 타임아웃 및 오류 처리 전략 수립 (KoBART, Pexels API, pyttsx3)
