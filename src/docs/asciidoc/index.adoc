...
* `profileImageUrl`: String - 프로필 이미지 URL(대체 필드)
...
* `thumbnailUrl`: String - 표지 이미지 URL
...
* `user`: User - 사용자
* `content`: ShortFormContent - 콘텐츠
* `interactionType`: String - 상호작용 유형 (VIEW, LIKE, BOOKMARK, SHARE, COMMENT 등)
