...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    @Query("SELECT b FROM Book b WHERE b.isDeleted = false")
    @NonNull
    Page<Book> findByIsDeletedFalse(@NonNull Pageable pageable);
    ...
    @NonNull
    Page<Book> findByGenresContainingAndIsDeletedFalse(@Param("genre") String genre, @NonNull Pageable pageable);
