...
public record UserInterestResponse(
    ...
    public static class UserInterestResponseBuilder {
        ...
        public UserInterestResponseBuilder userId(Long userId) {
            this.userId = userId;
            return this;
        }

        public UserInterestResponseBuilder genres(List<String> genres) {
            this.genres = genres;
            return this;
        }

        public UserInterestResponseBuilder authors(List<String> authors) {
            this.authors = authors;
            return this;
        }

        public UserInterestResponseBuilder keywords(List<String> keywords) {
            this.keywords = keywords;
            return this;
        }

        public UserInterestResponseBuilder bio(String bio) {
            this.bio = bio;
            return this;
        }
