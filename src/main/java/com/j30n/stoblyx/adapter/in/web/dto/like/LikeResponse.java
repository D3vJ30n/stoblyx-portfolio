...
public record LikeResponse(
    ...
    public static class LikeResponseBuilder {
        ...
        public LikeResponseBuilder userId(Long userId) {
            this.userId = userId;
            return this;
        }

        public LikeResponseBuilder username(String username) {
            this.username = username;
            return this;
        }

        public LikeResponseBuilder quoteId(Long quoteId) {
            this.quoteId = quoteId;
            return this;
        }

        public LikeResponseBuilder createdAt(LocalDateTime createdAt) {
