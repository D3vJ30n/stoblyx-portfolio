...
public record ContentResponse(
    ...
    public static class ContentResponseBuilder {
        ...
        public ContentResponseBuilder id(Long id) { this.id = id; return this; }
        public ContentResponseBuilder videoUrl(String videoUrl) { this.videoUrl = videoUrl; return this; }
        public ContentResponseBuilder thumbnailUrl(String thumbnailUrl) { this.thumbnailUrl = thumbnailUrl; return this; }
        public ContentResponseBuilder bgmUrl(String bgmUrl) { this.bgmUrl = bgmUrl; return this; }
        public ContentResponseBuilder subtitles(String subtitles) { this.subtitles = subtitles; return this; }
        public ContentResponseBuilder status(ContentStatus status) { this.status = status; return this; }
        public ContentResponseBuilder viewCount(int viewCount) { this.viewCount = viewCount; return this; }
        public ContentResponseBuilder likeCount(int likeCount) { this.likeCount = likeCount; return this; }
        public ContentResponseBuilder shareCount(int shareCount) { this.shareCount = shareCount; return this; }
        public ContentResponseBuilder isLiked(boolean isLiked) { this.isLiked = isLiked; return this; }
        public ContentResponseBuilder isBookmarked(boolean isBookmarked) { this.isBookmarked = isBookmarked; return this; }
        public ContentResponseBuilder book(BookInfo book) { this.book = book; return this; }
        public ContentResponseBuilder quote(QuoteInfo quote) { this.quote = quote; return this; }
        public ContentResponseBuilder createdAt(LocalDateTime createdAt) { this.createdAt = createdAt; return this; }
        public ContentResponseBuilder modifiedAt(LocalDateTime modifiedAt) { this.modifiedAt = modifiedAt; return this; }
