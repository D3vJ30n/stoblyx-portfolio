...
class AIIntegrationTest {
    ...
    void generateMotivationBookMultimediaIntegrationTest() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        // When
        CompletableFuture<BookMultimediaDTO> future = aiAdapter.generateBookMultimedia(MOTIVATION_TITLE, MOTIVATION_DESCRIPTION);
    ...
    void generatePhilosophyBookMultimediaIntegrationTest() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        // When
        CompletableFuture<BookMultimediaDTO> future = aiAdapter.generateBookMultimedia(PHILOSOPHY_TITLE, PHILOSOPHY_DESCRIPTION);
    ...
    void koreanContentMultimediaTest() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        // When
        CompletableFuture<BookMultimediaDTO> future = aiAdapter.generateBookMultimedia(koreanTitle, koreanDescription);
